...
var render = function() {
  ...
  return _c(
    "Page",
    { staticClass: "page", on: { loaded: _vm.onPageLoaded } },
    [
      _c(
        "ActionBar",
        ...
        [
          _c("Label", {
            ...
            attrs: { text: _vm.appTitle + " (" + _vm.appStatus + ")" }
          })
        ],
        1
      ),
                    ...
                    scopedSlots: _vm._u([
                      {
                        ...
                        fn: function(ref) {
                          ...
                          return _c(
                            ...
                            [
                              _c("Label", {
                                staticClass: "listView-Item-Title",
                                attrs: {
                              ...
                              _c("Label", {
                                staticClass: "listView-Item-Description",
                                attrs: {
                                  backgroundColor: "white",
                                  row: "1",
                                  col: "0",
                ...
                [
                  _c(
                    ...
                    [
                      ...
                      _c("Span", {
                        attrs: { text: _vm.repository.length + " repositories" }
                      })
                    ],
                    1
                  )
